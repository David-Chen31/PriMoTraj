...
def main():
    parser = argparse.ArgumentParser('iTransformer trajectory baseline (strict dataloader control)')
    ...
    # Lightweight defaults for edge-resource comparison.
    ...
    for epoch in range(1, args.epochs + 1):
        ...
        for batch_x, batch_y in train_loader:
            ...
            if not timing_done:
                ...
                print(
                    f'One-batch timing | forward: {(t1 - t0) * 1000:.3f} ms | '
    ...
    print(
        'BENCHMARK|'
        f'model=iTransformer|seq_len={args.seq_len}|pred_len={args.pred_len}|'
